...
namespace Quartz.Tests.Unit.Core
{
    ...
    public class QuartzSchedulerTest
    {
        ...
        public void TestInvalidCalendarScheduling()
        {
            ...
            DateTime runTime = DateTime.Now.AddSeconds(10);

            // define the job and tie it to our HelloJob class
            JobDetailImpl job = new JobDetailImpl("job1", "group1", typeof(TestJob));

            // Trigger the job to run on the next round minute
            IOperableTrigger trigger = new SimpleTriggerImpl("trigger1", "group1", runTime);
            sched.AddCalendar("FOOBAR",new DailyCalendar("19:30","20:00"),true,true );
    ...
    public class TestJob : IJob
    {
        ...
        {
            Console.WriteLine("This is TestJob");
        }
    }
}
